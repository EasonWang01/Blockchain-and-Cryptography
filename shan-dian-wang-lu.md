...
3.之後兩人的文件產生出的交易花費的是同一筆Output，所以只有其中一個人的可以廣播，而為了避免兩人都想要拿錢，而先廣播出自己的，這份文件
分兩個部分，第一個部分是廣播後只有對方可以先拿到餘額，而經過1000個區塊確認（使用nSequence）後才會產生另一個交易，讓廣播的人可以拿到自己的餘額。

4.之後雙方有交易後，兩份文件的餘額會更動，而如果更動後有一方還想要廣播出舊的交易餘額的話會被懲罰 ( 在1000個區塊確認之前 ) ，懲罰的
...
3.假設小明關閉通道後，提出帳面餘額，但這時小黃拿出證據說小明提出的是假餘額證明的話，小明的餘額將被沒收，並給予小黃。 12
```
